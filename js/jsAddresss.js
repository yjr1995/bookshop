...
var provinceList = [  
{name:'北京', cityList:[           
{name:'市辖', areaList:['东城','西城','崇文','宣武','朝阳','丰台','石景山','海淀','门头沟','房山','通州','顺义','昌平','大兴','怀柔','平谷']},          
{name:'县', areaList:['密云县','延庆县']}  
]},  
{name:'上海', cityList:[           
{name:'市辖', areaList:['黄浦','卢湾','徐汇','长宁','静安','普陀','闸北','虹口','杨浦','闵行','宝山','嘉定','浦东新','金山','松江','青浦','南汇','奉贤']},           
{name:'县', areaList:['崇明县']}  
]},  
{name:'天津', cityList:[           
{name:'市辖', areaList:['和平','河东','河西','南开','河北','红桥','塘沽','汉沽','大港','东丽','西青','津南','北辰','武清','宝坻']},          
{name:'县', areaList:['宁河县','静海县','蓟　县']}  
]},  
{name:'重庆', cityList:[           
{name:'市辖', areaList:['万州','涪陵','渝中','大渡口','江北','沙坪坝','九龙坡','南岸','北碚','万盛','双桥','渝北','巴南','黔江','长寿']},           
...
{name:'市', areaList:['江津','合川','永川','南川']}  
]},  
{name:'四川', cityList:[           
{name:'成都', areaList:['市辖','锦江','青羊','金牛','武侯','成华','龙泉驿','青白江','新都','温江县','金堂县','双流县','郫　县','大邑县','蒲江县','新津县','都江堰','彭州','邛崃','崇州']},             
{name:'自市', areaList:['市辖','自流井','贡井','大安','沿滩','荣　县','富顺县']},             
{name:'攀枝花', areaList:['市辖','东　','西　','仁和','米易县','盐边县']},           
{name:'泸州', areaList:['市辖','江阳','纳溪','龙马潭','泸　县','合江县','叙永县','古蔺县']},           
{name:'德阳', areaList:['市辖','旌阳','中江县','罗江县','广汉','什邡','绵竹市']},          
{name:'绵阳', areaList:['市辖','涪城','游仙','三台县','盐亭县','安　县','梓潼县','北川羌族自治县','平武县','江油']},            
{name:'广元', areaList:['市辖','市中','元坝','朝天','旺苍县','青川县','剑阁县','苍溪县']},            
{name:'遂宁', areaList:['市辖','船山','安居','蓬溪县','射洪县','大英县']},            
{name:'内江', areaList:['市辖','市中','东兴','威远县','资中县','隆昌县']},            
{name:'乐山', areaList:['市辖','市中','沙湾','五通桥','金口河','犍为县','井研县','夹江县','沐川县','峨边彝族自治县','马边彝族自治县','峨眉山']},             
{name:'南充市', areaList:['市辖','顺庆','高坪','嘉陵','南部县','营山县','蓬安县','仪陇县','西充县','阆中']},            
{name:'眉山', areaList:['市辖','东坡','仁寿县','彭山县','洪雅县','丹棱县','青神县']},          
{name:'宜宾', areaList:['市辖','翠屏','宜宾县','南溪县','江安县','长宁县','高　县','珙　县','筠连县','兴文县','屏山县']},          
{name:'广安', areaList:['市辖','广安','岳池县','武胜县','邻水县','华莹']},            
{name:'达州', areaList:['市辖','通川','达　县','宣汉县','开江县','大竹县','渠　县','万源']},            
{name:'雅安', areaList:['市辖','雨城','名山县','荥经县','汉源县','石棉县','天全县','芦山县','宝兴县']},          
{name:'巴中', areaList:['市辖','巴州','通江县','南江县','平昌县']},          
{name:'资阳', areaList:['市辖','雁江','安岳县','乐至县','简阳市']},          
...
{name:'贵州', cityList:[           
{name:'贵阳', areaList:['市辖','南明','云岩','花溪','乌当','白云','小河','开阳县','息烽县','修文县','清镇']},          
{name:'六盘水', areaList:['钟山','六枝特','水城县','盘　县']},          
{name:'遵义', areaList:['市辖','红花岗','汇川','遵义县','桐梓县','绥阳县','正安县','道真仡佬族苗族自治县','务川仡佬族苗族自治县','凤冈县','湄潭县','余庆县','习水县','赤水','仁怀']},           
{name:'安顺', areaList:['市辖','西秀','平坝县','普定县','镇宁布依族苗族自治县','关岭布依族苗族自治县','紫云苗族布依族自治县']},             
...
{name:'毕节地', areaList:['毕节市','大方县','黔西县','金沙县','织金县','纳雍县','威宁彝族回族苗族自治县','赫章县']},           
...
{name:'云南', cityList:[           
{name:'昆明', areaList:['市辖','五华','盘龙','官渡','西山','东川','呈贡县','晋宁县','富民县','宜良县','石林彝族自治县','嵩明县','禄劝彝族苗族自治县','寻甸回族彝族自治县','安宁']},          
{name:'曲靖', areaList:['市辖','麒麟','马龙县','陆良县','师宗县','罗平县','富源县','会泽县','沾益县','宣威']},            
{name:'玉溪', areaList:['市辖','红塔','江川县','澄江县','通海县','华宁县','易门县','峨山彝族自治县','新平彝族傣族自治县','元江哈尼族彝族傣族自治县']},             
{name:'保山', areaList:['市辖','隆阳','施甸县','腾冲县','龙陵县','昌宁县']},            
{name:'昭通', areaList:['市辖','昭阳','鲁甸县','巧家县','盐津县','大关县','永善县','绥江县','镇雄县','彝良县','威信县','水富县']},            
{name:'丽江', areaList:['市辖','古城','玉龙纳西族自治县','永胜县','华坪县','宁蒗彝族自治县']},           
{name:'思茅', areaList:['市辖','翠云','普洱哈尼族彝族自治县','墨江哈尼族自治县','景东彝族自治县','景谷傣族彝族自治县','镇沅彝族哈尼族拉祜族自治县','江城哈尼族彝族自治县','孟连傣族拉祜族佤族自治县','澜沧拉祜族自治县','西盟佤族自治县']},             
{name:'临沧', areaList:['市辖','临翔','凤庆县','云　县','永德县','镇康县','双江拉祜族佤族布朗族傣族自治县','耿马傣族佤族自治县','沧源佤族自治县']},            
{name:'楚雄彝族自治州', areaList:['楚雄','双柏县','牟定县','南华县','姚安县','大姚县','永仁县','元谋县','武定县','禄丰县']},            
{name:'红河哈尼族彝族自治州', areaList:['个旧','开远市','蒙自县','屏边苗族自治县','建水县','石屏县','弥勒县','泸西县','元阳县','红河县','金平苗族瑶族傣族自治县','绿春县','河口瑶族自治县']},           
...
{name:'西藏', cityList:[           
{name:'拉萨', areaList:['市辖','城关','林周县','当雄县','尼木县','曲水县','堆龙德庆县','达孜县','墨竹工卡县']},          
...
{name:'河南', cityList:[           
{name:'郑州', areaList:['市辖','中原','二七','管城回族','金水','上街','邙山','中牟县','巩义','荥阳','新密','新郑','登封']},            
{name:'开封', areaList:['市辖','龙亭','顺河回族','鼓楼','南关','郊　','杞　县','通许县','尉氏县','开封县','兰考县']},            
{name:'洛阳', areaList:['市辖','老城','西工','廛河回族','涧西','吉利','洛龙','孟津县','新安县','栾川县','嵩　县','汝阳县','宜阳县','洛宁县','伊川县','偃师']},          
{name:'平顶山', areaList:['市辖','新华','卫东','石龙','湛河','宝丰县','叶　县','鲁山县','郏　县','舞钢','汝州']},             
{name:'安阳', areaList:['市辖','文峰','北关','殷都','龙安','安阳县','汤阴县','滑　县','内黄县','林州']},            
{name:'鹤壁', areaList:['市辖','鹤山','山城','淇滨','浚　县','淇　县']},            
{name:'新乡', areaList:['市辖','红旗','卫滨','凤泉','牧野','新乡县','获嘉县','原阳县','延津县','封丘县','长垣县','卫辉','辉县']},          
{name:'焦作', areaList:['市辖','解放','中站','马村','山阳','修武县','博爱县','武陟县','温　县','济源市','沁阳','孟州']},            
{name:'濮阳', areaList:['市辖','华龙','清丰县','南乐县','范　县','台前县','濮阳县']},          
{name:'许昌', areaList:['市辖','魏都','许昌县','鄢陵县','襄城县','禹州','长葛']},          
{name:'漯河', areaList:['市辖','源汇','郾城','召陵','舞阳县','临颍县']},            
{name:'三门峡', areaList:['市辖','湖滨','渑池县','陕　县','卢氏县','义马','灵宝']},             
{name:'南阳', areaList:['市辖','宛城','卧龙','南召县','方城县','西峡县','镇平县','内乡县','淅川县','社旗县','唐河县','新野县','桐柏县','邓州']},            
{name:'商丘', areaList:['市辖','梁园','睢阳','民权县','睢　县','宁陵县','柘城县','虞城县','夏邑县','永城']},            
{name:'信阳', areaList:['市辖','师河','平桥','罗山县','光山县','新　县','商城县','固始县','潢川县','淮滨县','息　县']},          
{name:'周口', areaList:['市辖','川汇','扶沟县','西华县','商水县','沈丘县','郸城县','淮阳县','太康县','鹿邑县','项城市']},          
{name:'驻马店', areaList:['市辖','驿城','西平县','上蔡县','平舆县','正阳县','确山县','泌阳县','汝南县','遂平县','新蔡县']}  
]},  
{name:'湖北', cityList:[           
